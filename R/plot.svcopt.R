...
plot.svcopt <- function(obj){
  ...
  col <- head(heat.colors(100), 71)[mat0]
  ...
  rect(xleft = nrow(mat1) * 1.1, ybottom = tempY[-length(tempY)], xright = nrow(mat1) * 1.15, ytop = tempY[-1], col = head(heat.colors(100),71), border = NA)
